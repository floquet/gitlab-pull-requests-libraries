...
#SBATCH --output=/scratch/users/dantopa/repos/gitlab/pull-requests/spack/tpl/openmpi/openmpi-4.0.1/bash/output/darwin-general-batch.out
...
sbatch /scratch/users/dantopa/repos/gitlab/pull-requests/spack/tpl/openmpi/openmpi-4.0.1/bash/darwin-power9-openmpi.sh
